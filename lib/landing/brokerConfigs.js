...
export const UI_STRINGS = {
    ...
    demo: {
      ...
      errors: {
        not_degiro: {
          ...
          body: (d) =>
            `This demo reads the DEGIRO Account Statement (Rekeningoverzicht) export.${
        ...
        parse_error: {
          ...
          body: (d) => d?.message ?? 'Please try exporting your DEGIRO Account Statement again as XLSX.',
        },
      },
    },
    trust: [
  ...
  nl: {
    demo: {
      ...
      errors: {
        not_degiro: {
          title: 'Dit lijkt geen DEGIRO-overzicht',
          body: (d) =>
            `Deze demo leest het DEGIRO-Rekeningoverzicht (Account Statement).${
              d?.detectedFormat && d.detectedFormat !== 'generic' && d.detectedFormat !== 'unknown'
                ? ` We herkenden in plaats daarvan een ${d.detectedFormat}-bestand.`
                : ''
            } In DEGIRO: Inbox → Rekeningoverzicht → exporteer als XLSX, en sleep het hierheen.`,
        },
        degiro_transactions_export: {
        ...
        no_positions: {
          ...
          body: (d) =>
            d.matchedCount > 0
              ...
              : 'We lazen je DEGIRO-overzicht, maar vonden geen koop- of verkooptransacties.',
        },
        parse_error: {
          title: 'We konden dat bestand niet lezen',
          body: () => 'Zorg dat het een geldig DEGIRO-Rekeningoverzicht is (XLSX of CSV) en probeer het opnieuw.',
        },
      },
    },
    trust: [
    ...
    result: {
      ...
      statTwr: 'Portefeuille-TWR',
      statSpy: 'SPY totaalrendement',
      statVs: 'vs. SPY',
      chartHeading: 'Jouw posities vs. SPY',
      ...
      legendPortfolio: (v) => `— Portefeuille-TWR (${v})`,
