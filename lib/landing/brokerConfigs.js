  ...
  en: {
    demo: {
      ...
      errors: {
        ...
        too_many_positions: {
          title: 'More positions than the demo can chart',
          body: (d) =>
            `This account traded ${d.traded} positions. The demo can chart ${d.charted}, and no subset of that size represents the account without gaps in the timeline — so we can’t show a return here.`,
        },
        no_positions: {
  ...
  nl: {
    demo: {
      ...
      errors: {
        ...
        too_many_positions: {
          title: 'Meer posities dan de demo kan tonen',
          body: (d) =>
            `Dit account verhandelde ${d.traded} posities. De demo kan er ${d.charted} tonen, en geen selectie van die omvang vertegenwoordigt het account zonder gaten in de tijdlijn — dus kunnen we hier geen rendement laten zien.`,
        },
        no_positions: {
