...
export const SAMPLE_STOCK_INTEL = {
  AAPL: { rating: 6.2, thesis: "Quality moat at premium price. Services growth offsets hardware plateau, but China and regulatory drag are real overhangs.", pe: 33.4, mcap: '3.4T', shortFloat: '0.6%', earnDate: 'Jul 25', dy: '0.43%' },
  NVDA: { rating: 7.1, thesis: "AI infra leader with 92% data-center share. Valuation is the bear case — at 38× forward, perfection is priced in through 2027.", pe: 42.1, mcap: '4.3T', shortFloat: '1.0%', earnDate: 'May 28', dy: '0.02%' },
  TSLA: { rating: 4.3, thesis: "Auto unit decelerating, FSD optionality is the only multiple support. Delivery miss + margin compression = re-rating risk.", pe: 64.7, mcap: '0.8T', shortFloat: '3.1%', earnDate: 'Jul 23', dy: '—' },
  AMZN: { rating: 6.8, thesis: "AWS growth recovering from optimization cycle. Retail margin inflection real but slow. Ad business is the unsung compounder.", pe: 38.9, mcap: '2.2T', shortFloat: '0.7%', earnDate: 'Aug 01', dy: '—' },
  MSFT: { rating: 7.4, thesis: "Cleanest AI monetization story — Copilot attach + Azure inference. Premium multiple earned, but priced for flawless execution.", pe: 35.0, mcap: '3.1T', shortFloat: '0.5%', earnDate: 'Jul 30', dy: '0.71%' },
};
