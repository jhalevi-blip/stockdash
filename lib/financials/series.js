...
// One output row shared by all three charts. `ttmEbitda` is passed in separately so
// the leverage ratio is always on trailing-twelve-month EBITDA regardless of mode.
