...
- Primary cluster weight floor. A primary cluster must represent at least 10% of total equity (sum of position weights in the cluster ≥ 10%). Clusters below this threshold belong in honorable_mentions instead, regardless of how strong the thesis or correlation signal is. The dominant single position rule (≥30%) overrides this floor — single positions ≥30% always become primary clusters of length 1. Honorable mentions have no minimum weight.
