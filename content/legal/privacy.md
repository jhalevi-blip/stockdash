...
**Clerk** — Authentication and user identity. Stores email addresses, hashed passwords, and OAuth identifiers. [Privacy policy](https://clerk.com/legal/privacy)

**Supabase** — Database. Stores your portfolio data (tickers, share counts, cost basis, cash positions) and links it to your account. [Privacy policy](https://supabase.com/privacy)

**Vercel** — Hosting and content delivery. Serves the website and may store anonymized request data via Vercel Web Analytics. [Privacy policy](https://vercel.com/legal/privacy-policy)
...
**Cloudflare** — DNS, content delivery, and email routing. May process technical request information to deliver the service. [Privacy policy](https://www.cloudflare.com/privacypolicy/)
...
You also have the right to lodge a complaint with a data protection authority. In the Netherlands, that is the [Autoriteit Persoonsgegevens](https://autoriteitpersoonsgegevens.nl/).
